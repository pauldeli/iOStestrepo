...
public class smokeTest {
	...
	public void setUp() throws Exception {
				...
				capabilities.setCapability("app", ""
						+ ""
						+ "DerivedData/Deli-btpebsgubslxxbgaoxzkqdudvtzz/Build/Products/Debug-iphonesimulator/deliapp.app");
				capabilities.setCapability("app", "/Users/stefanaronsen/Library/Developer/Xcode/DerivedData/Deli-dpibcmjkqigbooemrebljxgblcji/Build/Products/AppStore-iphonesimulator/deliapp.app");
				...
				try {
					...
					dr.findElement(By.xpath("//UIAApplication[1]/UIAWindow[2]/UIATableView[3]/UIATableCell[1]/UIATextField[1]")).click();
					...
					dr.findElement(By.xpath("//UIAApplication[1]/UIAWindow[2]/UIANavigationBar[1]/UIAButton[2]")).click();
                    dr.findElement(By.name("Los Angeles"));  //UIAApplication[1]/UIAWindow[2]/UIATableView[3]/UIATableCell[3]/UIAStaticText[1]
					...
					assertEquals(hiptexts.getText(), "EDM");
					
				
		   
					//Sign Out
					dr.findElement(By.xpath("//UIAApplication[1]/UIAWindow[2]/UIANavigationBar[1]/UIAButton[1]")).click();
					dr.findElement(By.xpath("//UIAApplication[1]/UIAWindow[2]/UIATableView[3]/UIATableCell[9]")).click();
					dr.findElement(By.name("Sign out of this account")).click();
